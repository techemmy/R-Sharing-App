    ...
    <header className="relative h-screen flex justify-center items-center">
      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 bg-clip-text mb-6 pb-4 text-4xl font-bold text-transparent md:text-6xl">Compass, Literally Go The Extra Miles in your Studies</h1>
          <p className="mx-auto mb-5 max-w-[528px] text-xl text-[#636262] lg:mb-8">Your Study Navigator</p>
          <Link to={'/signup'} className="inline-block rounded-full bg-blue-500 px-8 py-4 text-center font-bold text-black transition hover:border-black hover:bg-white">Get Started</Link>
